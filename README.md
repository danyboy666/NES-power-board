...
Zero Drop (Direct Drive): The circuit is designed to route the 5V directly to the motherboard with no obstacles, with absolutely almost no voltage drop even under peak loads (~900mA).
